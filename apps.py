...
# Lightly edited by Suaj for the redesign test
...
commands_help = {"hello": "A simple command that prints 'Hello World!'",
                ...
                "interactive": "Opens an interactive Python shell, requires 'iPython' installed",
...
def new(filename):
  if ".." in filename:
    ...
    subprocess.run(["touch", f"./home/{filename}"])
